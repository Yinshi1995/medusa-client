      ...
      <div className="txt-medium">
        {gift_cards.length > 0 && (
          <div className="flex flex-col mb-4">
            <Heading className="txt-medium">Подарункові картки застосовано:</Heading>
            {gift_cards?.map((gc) => (
              <div
              ...
              >
                ...
                >
                  <Trash size={14} />
                  <span className="sr-only">Видалити подарункову картку із замовлення</span>
                </button>
              </div>
            ))}
          </div>
        ...
        {appliedDiscount ? (
          <div className="w-full flex items-center">
            <div className="flex flex-col w-full">
              <Heading className="txt-medium">Знижка застосована:</Heading>
              <div
              ...
              >
                ...
                >
                  ...
                  Видалити код знижки із замовлення
                  </span>
                </button>
              </div>
            </div>
          ...
          <form action={formAction} className="w-full">
            <Label className="flex gap-x-1 my-2 items-center">
              ...
              >
                Додайте подарункову картку або код знижки
              </button>
